...
\begin{figure}[H]
      \centering
      \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/1-menu-sop-umum.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/2-halaman-sop-umum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/1-tombol-tambah-umum.png}
    \caption{Tampilan Tombol Tambah SOP Umum}
    \label{fig:bagan-alir}
\end{figure}
\vspace{-2em}

Setelah klik tombol “Tambah SOP", akan dialihkan ke halaman form tambah SOP Umum. User akan diminta untuk mengisi Judul SOP, Nomor SOP, Tanggal Pembuatan, Tanggal Revisi, Tanggal Efektif, Kata Kunci, memilih SOP Level (Pilih Umum), memilih Status Arsip, dan pilih Lintas Fungsi.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/2-export-sop-umum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=4.35cm]{media/sop-umum-unit/3-hasil-export.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/4-filter-sop-umum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/5-icon-pesawat.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-Umum-unit/8-halaman-detail-sop-Umum.png}
    \label{fig:bagan-alir}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=4.45cm]{media/sop-Umum-unit/8-halaman-detail-sop-Umum-2.png}
    \label{fig:bagan-alir}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=4.75cm]{media/sop-Umum-unit/8-halaman-detail-sop-Umum-3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=5.35cm]{media/sop-umum-unit/7-icon-pencil.png}
    \caption{Tombol Ubah SOP Umum}
    \label{fig:bagan-alir}
\end{figure}

Setelah diklik maka akan diarahkan ke form ubah SOP Umum. Sesuaikan isian pada kolom isi di form Ubah SOP Umum.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm, height=4.75cm]{media/sop-umum-unit/8-hapus-sop-umum.png}
