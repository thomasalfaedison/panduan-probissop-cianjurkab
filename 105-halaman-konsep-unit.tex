...
\begin{figure}[H]
      \centering
      \includegraphics[width=12.45cm]{media/konsep/1-menu-konsep.png}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=12.45cm]{media/konsep/2-halaman-konsep.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/1-tombol-tambah-sop.png}
    \caption{Tampilan Tombol Tambah Konsep}
    \label{fig:bagan-alir}
\end{figure}
\vspace{-2em}

Setelah klik tombol “Tambah SOP", akan dialihkan ke halaman form tambah SOP Umum. Untuk Form Tambah Konsep, secara tampilan dan kolom isian masih sama seperti Form Tambah SOP Unit seperti akan diminta untuk mengisi Judul SOP, Nomor SOP, Tanggal Pembuatan, Tanggal Revisi, Tanggal Efektif, Kata Kunci, memilih SOP Level, memilih Status Arsip, dan pilih Lintas Fungsi.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/1-export-konsep.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/2-hasil-export-konsep.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/3-filter-konsep.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/4-icon-pesawat.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/5-tombol-detail-konsep.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/6-halaman-detail-konsep.png}
    \label{fig:bagan-alir}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/6-halaman-detail-konsep-2.png}
    \label{fig:bagan-alir}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/6-halaman-detail-konsep-3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12.45cm]{media/konsep/7-icon-pencil-konsep.png}
